...
const S = {
  ...
  etnewssk:  { n: 14, url: 'https://www.etnews.com/20250715000111',
               t: '전자신문, "SK하이닉스, 용인 클러스터에 AI 도입"(2025.7.15)' },
...
const T1 = [
  ...
  ['오믹스에이아이', '피지컬 AI 자율주행 실험실\n(Revvity 공동 구축)\n신동명 대표', '단백체(프로테오믹스) 분석',
   '{om1:물리 실험 공정과 AI 분석 시스템을 결합해 사람 개입 없이 24시간 가동하는 단백체 분석 인프라를 구축}, 분석 기간을 6주 → 2주 이내로 단축. {om2:Revvity의 자동화 장비와 자사 AI 분석기술을 결합해 실험 설계–데이터 생성–분석–해석 전 과정을 자동화·지능화하는 프로젝트 진행 중}',
   '★★☆\n분석 전과정 무인 + AI 피드백'],
