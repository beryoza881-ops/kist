...
const S = {
  ...
  zdnet:     { n: 3,  url: 'https://zdnet.co.kr/view/?no=20260811095548',
               t: 'ZDNet Korea, "로봇이 알아서 연구…자율실험실 구축 \'시동\'"(2026.8.11) — 분과별 참여기업 명단' },
  ...
  newsis:    { n: 6,  url: 'https://www.newsis.com/view/NISX20250801_0003275713',
               t: '뉴시스, "\'연구자 없이 AI가 신소재 개발\'…KAIST·포스코, \'자율탐색 연구실\' 공개"(2025.8.1)' },
  mtlg:      { n: 7,  url: 'https://www.mt.co.kr/industry/2025/09/22/2025092208113590509',
               t: '머니투데이, "LG화학, 국내 화학업계 최초로 \'로봇 자동화 실험실\' 구축"(2025.9.22)' },
  ...
  jw:        { n: 10, url: 'https://www.economytalk.kr/news/articleView.html?idxno=422019',
               t: '이코노미톡뉴스, "AI가 설계하고 로봇이 합성한다… JW중외제약, 신약개발 실험"' },
  ...
  etnewssk:  { n: 14, url: 'https://www.etnews.com/20250715000111',
               t: '전자신문, "\'세계 최고 자동화 팹 만든다\'…SK하이닉스, 용인 클러스터에 AI 도입"(2025.7.15)' },
  ...
  sblg:      { n: 20, url: 'https://www.g-enews.com/article/Bio-Pharma/2025/05/20250521085942743d7a510102_1',
               t: '글로벌이코노믹, "삼성바이오로직스, AI·로봇으로 생산 효율 극대화 나서"' },
  standigm:  { n: 21, url: 'https://www.biospectator.com/news/view/6065',
               t: '바이오스펙테이터, "스탠다임, AI기반 신약개발 혁신성…\'NASH 치료제로 입증\'"' },
  hits:      { n: 22, url: 'https://kidd.co.kr/news/245880',
               t: '산업일보(KIDD), "\'30초면 결합 예측 끝\'… 히츠, AI 신약개발 \'속도전\' 나선다"' },
  ...
  virtuallab:{ n: 24, url: 'https://www.etnews.com/20230912000154',
               t: '전자신문, "버추얼랩, 소재 데이터 플랫폼 \'D3스퀘어\' 출시…데이터 기반 신소재 연구 환경 제공"' },
  lotte:     { n: 25, url: 'https://www.smarttoday.co.kr/ko-kr/articles/108746',
               t: '스마트투데이, "화학에도 분 AI 바람…LG·롯데·금호 앞장서"' },
  ...
  hellodd2:  { n: 28, url: 'https://www.hellodd.com/news/articleView.html?idxno=111104',
               t: '헬로디디, "AI가 논문 100만편 읽고 설계, 로봇은 밤샘 실험…\'자율랩\' 전쟁"(2026.3.12)' },
  bizhankook:{ n: 28, url: 'https://www.bizhankook.com/bk/article/32660',
               t: '비즈한국, "제약·바이오도 피지컬 AI 열풍 \'AI가 설계하고 로봇이 24시간 실험\'"' },
...
// ---------- 개요 박스 ----------
const boxText =
  '기업의 자율실험실은 대학·출연(연)과 달리 “위험·반복 실험의 무인화”와 “개발기간 단축”이라는 뚜렷한 사업 목적에서 출발해, ' +
  '분석·합성 자동화를 먼저 깔고 그 위에 AI 의사결정을 얹는 순서로 진행되고 있다. ' +
  '{kaistmse:포스코홀딩스}(이차전지 양극재)와 {jw:JW중외제약}(항암 신약)은 이미 AI가 다음 실험을 결정하는 폐루프에 도달했고, ' +
  '{mtlg:LG화학}·{cj:CJ제일제당}·{etnewssk:SK하이닉스}는 분석·평가 공정의 무인화 단계에 있다. ' +
...
const T1 = [
  ['포스코홀딩스', '미래기술연구원\nLIB소재연구센터 자율탐색 실험실\n(KAIST 서동화 교수팀 공동)', '이차전지 양극재',
   '{newsis:정량·혼합·소성·분석 전 과정을 연구자 개입 없이 수행}. 24시간 운용 시 {hankyung12:실험 데이터 12배 이상 확보·소재 탐색 시간 93% 단축}, 고속 소결 도입으로 합성 속도 50배 개선. {kaistmse:2026년 이후 업그레이드판을 자체 연구소에 적용 예정}',
   '★★★\n폐루프 자율탐색(24h)'],
  ...
  ['JW중외제약', 'AI 신약 플랫폼 ‘제이웨이브(JWave)’\n+ 로봇 합성 자동화 자율 연구실', '항암 신약 후보물질',
   '{jw:4만여 개 화합물·500여 종 세포주·오가노이드 데이터를 기반으로 AI가 후보물질을 설계 → 로봇이 자동 합성 → 결과를 AI가 재학습}하는 폐루프 구조. 보건복지부 구조기반 AI 신약개발 지원사업 주관기관(3년)으로 선정',
   '★★★\n설계–합성–학습 폐루프'],
  ...
  ['CJ제일제당', 'BIO연구소 {cj:바이오파운드리}', '균주 개발·발효 소재',
   '균주 개발과 생산공정을 로봇으로 자동화. 내부 데이터를 학습한 {seoulbio:‘바이오 에이전트 AI’ 도입으로 균주 평가 기간을 5개월 → 1개월로 단축}. 4만 3,000t 규모 미생물 발효 생산능력과 연계',
   '★★☆\nDBTL 자동화 + AI 에이전트'],
  ['SK하이닉스', '미래기술연구원\nAMS(Advanced Measurement System)', '반도체 계측·분석',
   '{etnewssk:실험 자재 계측에 AMS를 적용, 전체 장비로 확대 시 엔지니어 5명분에 해당하는 월 3,000건 판정을 자동화}. 용인 클러스터를 세계 최고 수준의 자동화 팹으로 구축 추진',
   '★☆☆\n계측·판정 자동화 단계'],
  ['에코프로', '{ecopro1:전사 AX 로드맵}\n(자율제조 공장 + 자율실험실)', '이차전지 양극재·전구체',
   '생산 현장에 피지컬 AI를 도입해 {ecopro1:자율제조 공장과 자율실험실 구축을 추진}, 위험 작업을 로봇이 대신하고 365일 24시간 상시 실험 체계를 목표. {ecopro2:AI가 축적된 실험 데이터를 학습해 소재 물성을 예측하고 최적 실험 조건을 도출, 연구개발~양산 기간 50% 단축 목표}(2028년 전 부문 AI 도입)',
   '★☆☆\n구축 추진 단계(~2028)'],
...
const legend = new Paragraph({
  ...
  children: runs('※ 자율실험 정도  ★★★ 설계–실험–분석–재설계가 폐루프로 무인 순환  |  ★★☆ 실험 전 과정 자동화 + AI 부분 적용(사람 개입 일부 잔존)  |  ★☆☆ 개별 공정 자동화 단계', { size: 13, color: '666666' }),
});
...
const T2 = [
  ['자동화\n(생산·품질)', '삼성바이오로직스', '바이오의약품 생산',
   '{sbl:제5공장에 AI·자율주행로봇·자동화를 적용}하고, 다변량 데이터 분석과 머신러닝으로 생산공정의 미세한 변화를 실시간 감지. {sblg:AI를 활용해 인적 오류 ‘제로’를 목표}로 생성형 AI 기반 업무 자동화도 병행'],
  ...
  ['자동화\n(장비 공급)', '파크시스템스·에이치비솔루션\n·로봇앤드디자인', '계측·장비 자동화',
   '{zdnet:자율실험실 협의체 「기술·플랫폼·표준」 분과(32명)에 참여}해 장비 인터페이스와 데이터 표준 정립, 레퍼런스 자율실험실 구축을 추진'],
  ['AI 지원\n(공정)', '롯데케미칼·롯데정밀화학', '석유화학·정밀화학',
   '{lotte:AI 기반 품질검사·컬러매칭 시스템 도입으로 일일 생산성이 수작업 대비 약 50% 향상}. 롯데정밀화학은 특허·논문 분석·추천 AI 플랫폼을 신소재 연구지원에 활용'],
];
