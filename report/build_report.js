...
const S = {
  ...
  unistnat: { n: 18, url: 'https://www.aitimes.kr/news/articleView.html?idxno=36596',
              t: '인공지능신문, "UNIST 그쥐보프스키 교수팀, 자동화 플랫폼으로 화학 반응 네트워크 맵핑"(Nature, 2025.9.25)' },
  ibs:      { n: 19, url: 'https://www.ibs.re.kr/kor/sub02_06_01.do',
...
const T1 = [
  ['KIST', '계산과학연구센터\n한상수 센터장·김동훈 박사\n(고려대 이관영 교수 공동)', '금속 나노입자·나노소재',
   '목표 물성 입력 → 로봇 합성 → 광특성 측정 → AI 재설계의 폐루프 구현. {segye:변수 3개짜리 소재 기준, 필요한 실험 횟수를 최대 실험 횟수의 1/500 수준으로 감축}, {sedailyAI:태양전지 활성층용 은 나노입자 개발}. 원격·다중사용자 운영체계 {octopus:‘OCTOPUS’로 개발시간 5배 이상 단축}',
   '★★★\n폐루프 완전자율(24h 무인)'],
  ...
  ['KAIST ×\n포스코홀딩스', '신소재공학과 {kaistmse:서동화 교수팀}\n– 포스코홀딩스 미래기술연구원\n자율탐색 실험실', '이차전지 양극재',
   '{asiae:정량·혼합·펠릿화·소성·분석을 연구자 개입 없이 수행}하는 자동화 시스템 + 분석 데이터를 해석해 최적 후보를 고르는 AI 모델 결합. {kaistmse:소재 탐색 기간 93% 단축·기존 연구자 기반 실험 대비 12배 많은 데이터 확보}',
   '★★★\n산·학 공동 폐루프 실증'],
  ['한국에너지\n기술연구원(KIER)', '청정연료연구실\n박지찬 박사 연구진', '촉매 성능평가',
  ...
  ['UNIST · IBS', '{ibs:인공지능 및 로봇 기반 합성 연구단}\nBartosz A. Grzybowski 단장\n(UNIST 화학과)', '유기합성·화학반응 네트워크',
   '{unist:AI–로봇 플랫폼으로 하루 약 1,000회 화학반응 실험 수행}. {unistnat:150년 된 한츠슈 피리딘 합성의 반응 네트워크를 정밀 지도화해 기존에 알려진 7종 외에 새로운 중간체·생성물 9종을 규명}, 2025년 9월 Nature 게재',
   '★★★\n고속 폐루프 탐색'],
...
const T2 = [
  ...
  ['자동화\n(대형 인프라)', '포항가속기연구소(PAL)\n— POSTECH 부설', '방사광 기반 소재 분석',
   '{pal:3세대 PLS-II와 4세대 PAL-XFEL을 함께 운영}하는 국내 유일의 대형 가속기 인프라로, 자율실험실이 필요로 하는 고속·정밀 구조분석을 뒷받침한다. {palmou:코스맥스 등 기업과 MOU를 맺어 첨단 분석 인프라를 개방}(공개 자료상 폐루프 자율실험 운영은 확인되지 않음)'],
