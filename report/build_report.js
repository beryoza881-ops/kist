...
const S = {
  ...
  hitnews:  { n: 24, url: 'https://www.hitnews.co.kr/news/articleView.html?idxno=77438',
...
const T1 = [
  ...
  ['이화여자대학교', '{ewha:멀티스케일 물질 및 시스템 연구소(IMMS)}\nOA-SDL(개방형 자율실험실)\n문회리 소장(화학·나노과학과)', '멀티스케일 소재·에너지·반도체',
   '{ewhaimms:산학협력관에 약 517㎡ 규모로 구축 중}. 클라우드 원격제어로 국내외 연구자가 어디서든 접속해 실험하는 개방형(Open-Access) 운영이 특징. {ewha:국가연구소(NRL 2.0)에 선정돼 10년간 1,000억 원(연 100억 원) 블록펀딩}, {ewhana:자율실험실 공정기술 개발에 착수}',
   '★★☆\n개방형 SDL 구축 중(2026~)'],
